...
#
# Script generated by Vivado on Wed May 28 22:49:09 -0400 2025
...
#
# Usage        : floating_point_3.sh
#                floating_point_3.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                floating_point_3.sh [-reset_run]
#                floating_point_3.sh [-reset_log]
#                floating_point_3.sh [-help]
#
...
#                script (type 'floating_point_3.sh -help' for more information).
#
...
# script info
echo -e "floating_point_3.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./floating_point_3.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  ...
  xmvhdl -work floating_point_v7_1_18 $xmvhdl_opts \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.floating_point_3 xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.floating_point_3 -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log floating_point_3_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
Usage: floating_point_3.sh [-step]\n\
Usage: floating_point_3.sh [-lib_map_path]\n\
Usage: floating_point_3.sh [-reset_run]\n\
Usage: floating_point_3.sh [-reset_log]\n\
Usage: floating_point_3.sh [-keep_index]\n\
