...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.floating_point_3 xil_defaultlib.glbl -o floating_point_3_simv
}
...
reset_run()
{
  files_to_remove=(ucli.key floating_point_3_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc floating_point_3_simv.daidir vcs_lib c.obj)
