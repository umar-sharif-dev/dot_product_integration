...
HD_PWD='/home/hp/Desktop/hassan_ai/dot_product_sim/dot_product_sim.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_dot_product_engine.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_dot_product_engine.tcl -notrace
