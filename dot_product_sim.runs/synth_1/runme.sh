...
HD_PWD='/home/hp/Desktop/hassan_ai/dot_product_sim/dot_product_sim.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_dot_product_engine.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_dot_product_engine.tcl
